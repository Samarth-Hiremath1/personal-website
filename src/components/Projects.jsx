...
const ProjectCard = ({ project, isLeft }) => {
  return (
    <div className={`project-card ${isLeft ? 'left' : 'right'} relative group transform hover:scale-105 transition duration-300 bg-gray-800 rounded-lg overflow-hidden mb-4`}>
...
//   <h1 className="text-4xl text-white font-bold text-center mb-12">Projects</h1>
//   <p className="text-lightGray italic text-center mb-20">Some projects I worked on over the past few years</p>
//   <div className="flex flex-col space-y-8 md:grid md:grid-cols-2 md:gap-8 px-4 md:px-8 lg:px-32">
//     {projectsData.map((project, index) => (
//       <div key={project.id} className="relative" style={{ marginTop: index % 2 === 1 && window.innerWidth >= 768 ? '12rem' : '0rem' }}>
